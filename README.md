...
Before running the framework, the SAM source code need to be downloaded and placed in the subdirectory (SAM/). The source codes are from [SAM1](https://github.com/facebookresearch/segment-anything),[SAM2](https://github.com/facebookresearch/sam2).
